...
-- Group 49
-- doko
-- (Most) code was done by us. See following citation.
-- ---------------------------------------------------------------------------
-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
CREATE TABLE Tasks (
    ...
    `desc` TEXT,
    statId INT,
    FOREIGN KEY (statId) REFERENCES Statuses (statId) ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO
    Statuses (title, boardId)
VALUES ('To Do', 1), -- StatId 1 for Work Projects
    ...
    ('Submitted', 5);
-- StatId 15 for School Assignments

-- Insert sample tasks for each board's statuses
INSERT INTO
    Tasks (title, `desc`, statId)
VALUES
    -- Tasks for 'Work Projects' (Board 1)
    (
        'Finish Q3 Report',
        'Complete the financial analysis and write the summary.',
        1
    ),
    (
        'Review Marketing Plan',
        'Check for consistency and budget alignment.',
        2
    ),
    (
        'Deploy new feature',
        'Push the latest code to production environment.',
        3
    ),
    (
        'Onboard new intern',
        'Prepare training materials and schedule meetings.',
        1
    ),

-- Tasks for 'School Projects' (Board 2)
(
    'Write essay on Shakespeare',
    'Focus on Hamlet and Macbeth themes.',
    4
),
(
    'Prepare presentation',
    'Create slides for the science fair project.',
    5
),
(
    'Read chapter 5',
    'Finish the required reading for tomorrow''s class.',
    6
),
...
(
    'Plan next painting',
    'Sketch out a new landscape idea.',
    7
),
(
    'Start woodworking project',
    'Begin carving the new bookshelf.',
    8
),
(
    'Finish novel',
    'Complete the final chapter of "The Great Gatsby."',
    9
),
...
(
    'Complete 10k run',
    'Successfully finish the city race.',
    12
),
...
(
    'Math problem set',
    'Problems 1-10 from the textbook.',
    13
),
(
    'Biology lab report',
    'Write up the results from the dissection.',
    14
),
(
    'History presentation',
    'Research and present on the French Revolution.',
    15
);
...
VALUES (1, 1), -- Finish Q3 Report (Urgent)
    ...
    (7, 5);
-- Plan next painting (Feature - just an example)